...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '86a7a857036940ad95cc4f72d69a5fd1',
  ...
  THEME_SWITCH_DRAG: process.env.NEXT_PUBLIC_THEME_SWITCH_DRAG || false, // 是否允许拖拽切换主题
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，I am Nathan Pham, a DevOps Engineer🎉',
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'DevOps Blog', // 站点描述，被notion中的页面描述覆盖
