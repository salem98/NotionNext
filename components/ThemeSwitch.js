...
const ThemeSwitch = () => {
  ...
  // Check if THEME_SWITCH_DRAG is true in blog.config.js
  const isDraggable = process.env.THEME_SWITCH_DRAG === 'true'

  // Conditionally render based on the value of isDraggable
  return isDraggable ? (
    <Draggable>
      <div
        id="draggableBox"
      ...
      <div
        className={`${isLoading ? 'opacity-50 ' : 'opacity-0'} w-screen h-screen bg-black text-white shadow-text flex justify-center items-center
